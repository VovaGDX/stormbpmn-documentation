...
Полный перечень привилегий, которые администратор отмечает галочками при настройке группы. Три столбца показывают состав групп по умолчанию, последний — потолок участника с правом **«Просмотр»**: он действует поверх любой группы, в которую человека включили.
