...
Если непонятно, как настроить права под вашу задачу, или поведение системы расходится с описанным здесь, напишите в [техническую поддержку](../support/README.md): **help@stormbpmn.com** или [@Stormbpmn_bot](https://t.me/stormbpmn_bot).
:::
